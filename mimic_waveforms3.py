...
-- mimic_waveforms3.csv -- This will output the iteration numbers (data integrity check)
-- wpatient_abp.npy 
-- wname0_abp.npy
-- wname1_abp.npy
-- wtime_abp.npy
...
python mimic_waveforms3.py | out-file mimic_waveforms3.csv -encoding ASCII
